...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  const { onSend = () => {}, isLoading = false, placeholder = "輸入訊息...", className } = props;
    ...
    <>
      ...
      >
            ...
            {files.map((file, index) => (
              <div key={index} className="relative group">
                {isImageFile(file) && filePreviews[file.name] ? (
                  ...
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-[#2E3033] rounded-lg text-sm text-gray-300">
        ...
        <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
          ...
          >
            <PromptInputAction tooltip="上傳檔案">
              <button
              ...
              >
                ...
                <input
                  ...
                  accept=".txt,.md,.csv,.json,.html,.xml,.log,image/*"
                />
              </button>
            </PromptInputAction>
          </div>
